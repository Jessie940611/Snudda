...
mpiexec -np 8 ./x86_64/special -mpi -python ./snudda/simulate/simulate.py network/network-putative-synapses-MERGED.hdf5 network/input-spikes.hdf5  --time 0.01 --voltOut network/simulation/volt.txt  --distributePolicy RoundRobin

...
To run neuromdulation, generate new parameter.json files which included the degree of modulation (i.e. increase 10% is 1.1), taken from literature or estimated 
...
for cell_type in ['fs', 'chin', 'lts']:
    ...
    lib_factors = h5py.File('DA_modulation_factors/lib_modFactors_{}.h5'.format(cell_type), 'r')
